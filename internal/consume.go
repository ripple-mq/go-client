...
func (t *Broker[T]) RegisterConsumer(topic string, bucket string) <-chan any {
	...
	go consumeLoop[T](ch, resp.Address, resp.ConsumerId)
	return ch
}

func consumeLoop[T any](ch chan any, addr string, id string) {
